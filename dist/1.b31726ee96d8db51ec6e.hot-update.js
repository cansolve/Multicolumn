...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Crumbs = _wrapComponent('Crumbs')(function (_React$Component) {
	  ...
	  function Crumbs(props) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (Crumbs.__proto__ || (0, _getPrototypeOf2.default)(Crumbs)).call(this, props));
	
	    var val = Storage.get('key');
	    var appid = Storage.get('appid');
	    if (val == null) {
	      val = 1;
	    }
	    if (appid == null) {
	  ...
	  (0, _createClass3.default)(Crumbs, [{
	    ...
	    value: function sendAjax(event) {
	      ...
	      this.state.projects.map(function (project, i) {
	        if (project.id == val) {
	          Storage.set('appid', project.code);
	        }
	      });
...
//# sourceMappingURL=1.b31726ee96d8db51ec6e.hot-update.js.map