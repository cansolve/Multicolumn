	...
	var Header = _wrapComponent("Header")(function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Header, [{
	    ...
	    value: function render() {
	      return _react3.default.createElement("div", { className: "navbar navbar-default" }, _react3.default.createElement("div", { className: "navbar-container" }, _react3.default.createElement("div", { className: "navbar-header pull-left" }, _react3.default.createElement("a", { href: "#", className: "navbar-brand" }, _react3.default.createElement("small", null, _react3.default.createElement("i", { className: "icon-leaf" }), title))), _react3.default.createElement("div", { className: "navbar-header pull-right" }, _react3.default.createElement("ul", { className: "nav ace-nav" }, _react3.default.createElement("li", { className: "light-blue open" }, _react3.default.createElement("a", { href: "#" }, _react3.default.createElement("img", { className: "nav-user-photo", src: user, alt: "Photo" }), _react3.default.createElement("span", { className: "user-info" }, _react3.default.createElement("small", null, "\u6B22\u8FCE,"), "admin"), _react3.default.createElement("i", { className: "icon-caret-down" })))))));
	    }
	  }]);
	  return Header;
...
//# sourceMappingURL=1.326238d5bfe80aba2a2c.hot-update.js.map