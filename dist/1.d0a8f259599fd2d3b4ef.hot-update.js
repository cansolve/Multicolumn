	...
	var Left = _wrapComponent('Left')(function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Left, [{
	    ...
	    value: function render() {
	      ...
	      return _react3.default.createElement('div', { className: 'sidebar ' }, _react3.default.createElement('ul', { className: 'nav nav-list' }), _react3.default.createElement('div', { className: 'sidebar-collapse' }, _react3.default.createElement('i', { className: '' })));
	    }
	  }]);
	  return Left;
...
//# sourceMappingURL=1.d0a8f259599fd2d3b4ef.hot-update.js.map